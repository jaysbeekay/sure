...
ActiveRecord::Schema[8.1].define(version: 2026_08_31_090001) do
  ...
  create_table "loan_amortization_schedules", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["loan_id", "payment_number"], name: "index_loan_amortization_schedules_on_loan_id_and_payment_number", unique: true
    t.index ["payment_date"], name: "index_loan_amortization_schedules_on_payment_date"
  end
  ...
  create_table "loans", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.jsonb "rate_change_schedule", default: {}, null: false
    t.string "rate_type"
    t.string "subtype"
    t.integer "term_months"
    t.datetime "updated_at", null: false
    t.index ["next_rate_change_date"], name: "index_loans_on_next_rate_change_date"
  end
  ...
  add_foreign_key "loan_amortization_schedules", "loans"
